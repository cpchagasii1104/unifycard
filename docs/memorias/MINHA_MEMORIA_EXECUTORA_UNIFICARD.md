...
**HEAD pós-`F-COMPANY-USERS-SELF-UPDATE-AUTHORITY-ESCALATION-CLOSURE` (origem c6bbcae1) · branch `rescue-structural` · dev 366 · DT-mãe 0113 OPEN · R2 CONGELADO · FASE 6 não liberada. HOLD: aguardando reseal Yala.**
