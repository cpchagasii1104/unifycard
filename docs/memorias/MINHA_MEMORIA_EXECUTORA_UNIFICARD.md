...
**HEAD pós-`F-INVENTORY-LEGACY-READERS-RECONCILIATION-IMPL-PARTIAL` (origem ebde8984) · branch `rescue-structural` · dev 366 · DT-mãe 0113 OPEN · R2 CONGELADO · FASE 6 não liberada. HOLD: aguardando reseal Yala.**
