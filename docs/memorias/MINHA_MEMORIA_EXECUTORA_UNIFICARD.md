...
**HEAD pós-`F-C1-AUTO-REACHABLE-READ-PURITY` (origem 30dd2a16) · branch `rescue-structural` · DT-mãe 0113 OPEN · R2 CONGELADO · FASE 6 não liberada. HOLD: aguardando reseal Yala.**
