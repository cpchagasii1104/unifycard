...
**IMPLEMENTED / HOLD YALA.** Fecha SÓ como **F-PERMISSION-TRI-REGISTRY-RFC**: papel canônico dos 3 vocabulários
...
→ IMPLEMENTED_AS_RFC_BASELINE / HOLD YALA. dev 391. **Aguarda reseal Yala.**
