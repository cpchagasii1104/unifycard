...
export default function IntentComposer({ onSubmit, placeholder = 'Diga o que você quer que aconteça...' }: IntentComposerProps) {
  ...
  const handleTextSubmit = () => {
    ...
    // Se for evento e tiver sugestão de ocupação, incluir no preview
    const occupancyModel = classifiedIntent.intent === 'event' && classifiedIntent.occupancyModel ? {
      type: classifiedIntent.occupancyModel.type,
      requiresReservation: classifiedIntent.occupancyModel.requiresReservation ?? false,
