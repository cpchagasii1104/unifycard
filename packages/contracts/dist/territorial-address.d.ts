...
export type TerritorialNeighborhoodStatus = 'resolved' | 'candidate_requires_confirmation' | 'pending' | 'not_applicable';
...
export declare const TERRITORIAL_ADDRESS_ERROR_CODES: readonly ["authority_denied", "actor_not_eligible", "country_required", "country_not_supported", "postal_code_invalid", "provider_unavailable", "provider_not_found", "provider_conflict", "official_identifier_missing", "official_identifier_conflict", "canonical_city_missing", "canonical_city_ambiguous", "territorial_inconsistency", "territorial_confirmation_mismatch", "actor_territorial_in_progress", "idempotency_payload_mismatch", "invalid_address_payload", "unexpected_error"];
...
//# sourceMappingURL=territorial-address.d.ts.map