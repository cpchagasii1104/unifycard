...
# Orquestrador da validação F-PJ-PRODUCT-OFFER-ELIGIBILITY-GUARD (DECISION-0108 na camada de oferta).
...
$dbName = "unificard_offer_guard_$stamp"
...
try {
    ...
    try {
        ...
        Write-Host "teste F-PJ-PRODUCT-OFFER-ELIGIBILITY-GUARD..." -ForegroundColor Yellow
...
if ($exitCode -ne 0) { Write-Host "F-PJ-PRODUCT-OFFER-ELIGIBILITY-GUARD falhou (exit $exitCode)" -ForegroundColor Red; exit $exitCode }
Write-Host "F-PJ-PRODUCT-OFFER-ELIGIBILITY-GUARD verde." -ForegroundColor Green
exit 0
