...
const workerStatusRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post<{
    ...
    async (req, reply) => {
      ...
      try {
        const presence = await workerStatusService.goOnline(
          tenantId,
          userId,
          validated.latitude,
          validated.longitude
  ...
  fastify.post(
    ...
    async (req, reply) => {
      ...
      try {
        const presence = await workerStatusService.goOffline(tenantId, userId);
  ...
  fastify.post<{
    ...
    async (req, reply) => {
      ...
      try {
        const presence = await workerStatusService.updateLocation(
          tenantId,
          userId,
          validated
        );
  ...
  fastify.get<{ Params: { userId: string } }>(
    ...
    async (req, reply) => {
      ...
      try {
        const presence = await workerStatusService.getPresence(tenantId, userId);
