...
const createInstantRequestSchema = z.object({
...
const instantRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post<{
    ...
    async (req, reply) => {
      ...
      try {
        const result = await instantService.requestService(
          tenantId,
          userId,
          validated
        );
  ...
  fastify.post<{ Params: { requestId: string } }>(
    ...
    async (req, reply) => {
      ...
      const logRequestId = (req as any).requestId || req.id;
      ...
      try {
        const result = await instantService.acceptRequest(tenantId, requestId, userId);
  ...
  fastify.post<{ Params: { requestId: string } }>(
    ...
    async (req, reply) => {
      ...
      try {
        const request = await instantService.cancelRequest(tenantId, requestId, userId);
  ...
  fastify.get<{ Params: { requestId: string } }>(
    ...
    async (req, reply) => {
      ...
      const request = await instantService.getRequest(requestId);
