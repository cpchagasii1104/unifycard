...
// Controle explícito via flag ENABLE_PAYMENTS
// Se ENABLE_PAYMENTS=false ou não definido, pagamentos desabilitados sem warning
// Se ENABLE_PAYMENTS=true, STRIPE_SECRET_KEY é obrigatório (validado em env-validation)
const enablePayments = process.env.ENABLE_PAYMENTS?.toLowerCase() === 'true';

const stripe = enablePayments && process.env.STRIPE_SECRET_KEY
