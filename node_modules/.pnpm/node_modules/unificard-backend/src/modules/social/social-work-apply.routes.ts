...
import { applicationService } from '../work/applications/application.service';
import { workerService } from '../work/workers/worker.service';
import { rbacService } from '@core/rbac/rbac.service';
import { createApplicationSchema } from '../work/applications/application.schemas';

const socialWorkApplyRoutes: FastifyPluginAsync = async (fastify) => {
  /**
  ...
  fastify.get<{ Params: { postId: string } }>(
    ...
    async (req, reply) => {
      ...
      try {
        ...
        const result = await applicationService.listApplications(tenantId, {
          jobId: job.jobId,
        });
...
export default socialWorkApplyRoutes;
