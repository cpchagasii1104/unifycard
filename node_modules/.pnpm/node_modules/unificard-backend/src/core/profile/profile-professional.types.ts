 ...
 * 
 * AvailabilitySchedule é apenas INPUT declarativo de preferências de disponibilidade.
 * 
 * REGRAS ABSOLUTAS:
 * - NÃO bloqueia agenda
 ...
 * - READ-MODEL para exibição de preferências declaradas
 * 
 ...
 * - dayOfWeek: "monday", "tuesday", etc. | "specific": ["2024-12-25:09:00-12:00"]
