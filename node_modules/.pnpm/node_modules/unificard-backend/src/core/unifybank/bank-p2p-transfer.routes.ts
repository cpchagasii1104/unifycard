...
type P2PTransferBody = z.infer<typeof p2pTransferSchema>;

const bankP2PTransferRoutes: FastifyPluginAsync = async (fastify) => {
  /**
   ...
   */
  fastify.post<{ Body: P2PTransferBody }>('/p2p-transfer', async (req, reply) => {
