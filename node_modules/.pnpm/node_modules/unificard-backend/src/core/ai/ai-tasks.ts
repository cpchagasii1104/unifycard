...
export const AITasks = {
   ...
   */
  async analyzeModule(name: string): Promise<ModuleAnalysis> {
   ...
   */
  async proposeArchitecture(): Promise<ArchitectureProposal> {
   ...
   */
  async reviewCode(path: string): Promise<CodeReview> {
   ...
   */
  async validateProposal(proposal: string): Promise<{ valid: boolean; reasons: string[] }> {
   ...
   */
  async think(prompt: string): Promise<AIThought> {
