/*
Arquivo: 002_rbac.sql
Projeto: UnifyCard
Banco: PostgreSQL 14+
Escopo: Segurança / RBAC

Objetivo:
- Implementar controle de acesso baseado em papéis
- Relacionar usuários, papéis e permissões
- Disponibilizar funções auxiliares de autorização

Dependências:
- tenants, users (001_schema_genesis_ssot)

Observações:
- RBAC é multi-tenant por design
*/
...
COMMENT ON FUNCTION create_role_with_permissions IS
  'Helper to create a role and its permissions';
...
COMMENT ON FUNCTION seed_default_rbac IS
  'Seeds default RBAC roles and permissions for a tenant';
