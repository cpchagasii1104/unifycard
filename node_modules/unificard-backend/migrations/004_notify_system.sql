...
Dependências:
- tenants, users (001_initial_schema)
Observações:
...
ALTER TABLE IF EXISTS notify_templates ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS notify_queue ENABLE ROW LEVEL SECURITY;
