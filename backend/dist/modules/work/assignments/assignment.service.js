    ...
    async markAsCompleted(tenantId, assignmentId, reviewerUserId, reviewInput, options) {
      ...
      `, [tenantId, assignmentId]);
        ...
        `, [tenantId, assignment.workerId]);
            ...
            const clientAccounts = await accountService.getAccountsByOwner(tenantId, clientUserId, 'user');
            ...
            const workerAccounts = await accountService.getAccountsByOwner(tenantId, workerUserId, 'user');
            ...
            const tenantAccount = await accountService.getOrCreateSystemAccount(tenantId, 'platform_ops', 'BRL');
