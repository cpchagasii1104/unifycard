...
export interface Company {
  ...
  /** Par soberano da ativação operacional (DECISION-0098, Momento 2). Projeção read-only —
   *  o ÚNICO writer é activateCompanyOperationally. null = empresa ainda não operacional. */
