  ...
  async executePayment(
    ...
    if (isPix) {
      try {
        ...
        // Buscar contact_id do pagador se fornecido
        ...
        // Log mas não bloqueia criação de transaction
    ...
    // SPRINT 85: Se PIX, salvar pix_charge_id no metadata e retornar QR Code
    if (isPix && pixCharge) {
