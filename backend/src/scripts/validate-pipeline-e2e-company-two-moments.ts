...
async function main(): Promise<void> {
  ...
  // F-CNPJ-ACTIVATE-KYC-GATE (Art.4.2): ativar exige KYC mínimo do responsável. O fundador conclui
  // o KYC antes de ativar (estado realista); sem isso a ativação retorna 403.
