...
$EPHEMERAL = "unificard_follow_activation_e2e"
...
try {
  ...
  npx tsx src/scripts/validate-pipeline-e2e-follow-activation.ts
...
if ($failed) { exit 1 }
Write-Host 'FOLLOW ACTIVATION: OK' -ForegroundColor Green
exit 0
