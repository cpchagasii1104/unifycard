# run-economic-policy-territorial-coherence-ephemeral.ps1
# Orquestra o E2E da FATIA 0 (frente economic-policy, convergencia territorial p/ Location Core)
# em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_economic_policy_territorial_coherence_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e economic-policy-territorial-coherence ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-economic-policy-territorial-coherence.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E ECONOMIC-POLICY-TERRITORIAL-COHERENCE: OK' -ForegroundColor Green
exit 0
