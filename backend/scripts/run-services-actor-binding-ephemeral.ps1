# run-services-actor-binding-ephemeral.ps1
# Orquestra o E2E F-AUTHORITY-Z2-R6.1-SERVICES-ACTOR-BINDING em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_services_actor_binding_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e services-actor-binding ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-services-actor-binding.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E SERVICES-ACTOR-BINDING: OK' -ForegroundColor Green
exit 0
