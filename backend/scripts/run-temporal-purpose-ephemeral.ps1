# run-temporal-purpose-ephemeral.ps1
# Orquestra o E2E F-AGENDA-PURPOSE-CONCEPT-MATERIALIZATION em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_temporal_purpose_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e temporal-purpose ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-temporal-purpose.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E TEMPORAL-PURPOSE: OK' -ForegroundColor Green
exit 0
