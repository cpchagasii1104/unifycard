...
const guards = [
  ...
  'audit-audience-single-source.mjs',                               // F-VISIBILITY-CAPABILITY (Clayton 2026-07-07): FONTE UNICA de plateia — /audience-options deriva de PAIR_ALLOWED_LABELS; post/demanda/evento/locacao consomem (zero hardcode local)
