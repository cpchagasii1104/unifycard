...
const guards = [
  ...
  'audit-regional-fund-fk-canonical.mjs',                             // DECISION-0166 D3 (2e): fundo regional por FK canônica (regional_fund_accounts, hierarquia material, sem saldo em coluna), resolver FK com neighborhood HOLD, pipeline sem degradação FK→string, sink string morto, trilho paralelo regional_funds excisado sem recriação
  'audit-fiscal-canonical-house.mjs',                                 // DECISION-0166 D9 (4b): casa fiscal ÚNICA actor_fiscal_profiles ancorada em fiscal_identities; fantasmas company_profiles/tax_profiles aposentados (sem SQL vivo, não-materializáveis); TaxRegime único (sem redeclaração/grafias curtas); consumidores na casa canônica com fiscal_config_missing; sem alíquota hardcoded; módulo fiscal sem tocar dinheiro
