...
$EPHEMERAL = "unificard_pj_activation_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e pj-activation-route ...' -ForegroundColor Cyan
...
if ($failed) { exit 1 }
Write-Host 'E2E PJ-ACTIVATION-ROUTE: OK' -ForegroundColor Green
exit 0
