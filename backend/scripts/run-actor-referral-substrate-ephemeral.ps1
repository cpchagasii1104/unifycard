# run-actor-referral-substrate-ephemeral.ps1
# Orquestra o E2E F-ACTOR-REFERRAL-CODE-SUBSTRATE em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_actor_referral_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e actor-referral-substrate ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-actor-referral-substrate.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E ACTOR-REFERRAL-SUBSTRATE: OK' -ForegroundColor Green
exit 0
