# run-actor-capability-grants-slice1-ephemeral.ps1
# Orquestra o E2E F-ACTOR-CAPABILITY-GRANTS-SLICE-1 em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_actor_capability_grants_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e actor-capability-grants-slice1 ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-actor-capability-grants-slice1.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E ACTOR-CAPABILITY-GRANTS-SLICE-1: OK' -ForegroundColor Green
exit 0
