# run-erp-composed-ephemeral.ps1
# Orquestra o E2E F-ERP-COMPOSED-VIEW em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_erp_composed_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e erp-composed-view ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-erp-composed-view.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E ERP-COMPOSED-VIEW: OK' -ForegroundColor Green
exit 0
