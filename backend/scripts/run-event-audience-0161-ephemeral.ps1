...
$EPHEMERAL = "unificard_event_audience_0161_e2e"
...
try {
  ...
  npx tsx src/scripts/validate-pipeline-e2e-event-audience-0161.ts
...
if ($failed) { exit 1 }
Write-Host 'EVENT AUDIENCE 0161: OK' -ForegroundColor Green
exit 0
