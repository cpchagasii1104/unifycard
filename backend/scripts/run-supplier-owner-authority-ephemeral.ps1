# run-supplier-owner-authority-ephemeral.ps1
# Orquestra o E2E F-SUPPLIERS-OWNER-ACTOR-SCHEMA-WIRING em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_supplier_owner_authority_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e supplier-owner-authority ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-supplier-owner-authority.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E SUPPLIER-OWNER-AUTHORITY: OK' -ForegroundColor Green
exit 0
