# run-actor-capability-grants-endpoints-slice1b-ephemeral.ps1
# Orquestra o E2E F-ACTOR-CAPABILITY-GRANTS-ENDPOINTS-SLICE-1B em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_actor_grant_endpoints_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e actor-capability-grants-endpoints-slice1b ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-actor-capability-grants-endpoints-slice1b.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E ACTOR-CAPABILITY-GRANTS-ENDPOINTS-SLICE-1B: OK' -ForegroundColor Green
exit 0
