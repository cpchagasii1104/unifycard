# run-actor-page-ephemeral.ps1
# Orquestra o E2E F-ACTOR-PAGE-SHELL-SLICE-3 em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_actor_page_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e actor-page-contract ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-actor-page-contract.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E actor-page-contract: OK' -ForegroundColor Green
exit 0
