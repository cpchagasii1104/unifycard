...
$EPHEMERAL = "unificard_marketplace_domain_n0_e2e"
...
try {
  ...
  npx tsx src/scripts/validate-pipeline-e2e-marketplace-domain-n0-mapping.ts
...
if ($failed) { exit 1 }
Write-Host 'MARKETPLACE DOMAIN N0: OK' -ForegroundColor Green
exit 0
