# run-social-posts-actor-binding-ephemeral.ps1
# Orquestra o E2E F-AUTHORITY-Z2-R6.2-SOCIAL-POSTS-ACTOR-BINDING em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_social_posts_actor_binding_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e social-posts-actor-binding ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-social-posts-actor-binding.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E SOCIAL-POSTS-ACTOR-BINDING: OK' -ForegroundColor Green
exit 0
