# run-regional-fund-pf-resolver-ephemeral.ps1
# Orquestra o E2E F-REGIONAL-FUND-PF-RESOLVER em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_regional_fund_pf_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e regional-fund-pf-resolver ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-regional-fund-pf-resolver.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E REGIONAL-FUND-PF-RESOLVER: OK' -ForegroundColor Green
exit 0
