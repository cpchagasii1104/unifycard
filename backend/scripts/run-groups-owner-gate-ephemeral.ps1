# run-groups-owner-gate-ephemeral.ps1
# Orquestra o E2E F-AUTHORITY-Z2-R1-GROUPS-HANDROLLED-BYPASS-CONTAINMENT em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_groups_gate_authority_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e groups-owner-gate-authority ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-groups-owner-gate-authority.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E GROUPS-OWNER-GATE-AUTHORITY: OK' -ForegroundColor Green
exit 0
