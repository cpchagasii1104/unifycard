# run-delegation-scope-ephemeral.ps1
...
$EPHEMERAL = "unificard_delegation_scope_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e delegation-scope ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-delegation-scope-containment.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E DELEGATION-SCOPE: OK' -ForegroundColor Green
exit 0
