# run-po-owner-authority-ephemeral.ps1
# Orquestra o E2E F-C1-MONEY-PO-OWNER-ACTOR-SCHEMA-WIRING em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_po_owner_authority_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e po-owner-authority ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-po-owner-authority.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E PO-OWNER-AUTHORITY: OK' -ForegroundColor Green
exit 0
