# run-support-ticket-ephemeral.ps1
# Orquestra o E2E F-SUPPORT-TICKET-BUSINESS-FACT-GATE em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_support_ticket_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e support-ticket-business-fact-gate ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-support-ticket-business-fact-gate.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E SUPPORT-TICKET-BUSINESS-FACT-GATE: OK' -ForegroundColor Green
exit 0
