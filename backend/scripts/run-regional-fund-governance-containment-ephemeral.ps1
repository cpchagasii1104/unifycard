# run-regional-fund-governance-containment-ephemeral.ps1
# Orquestra o E2E F-REGIONAL-FUND-GOVERNANCE-SCHEMA-GHOST-CONTAINMENT em DB EFEMERA. NUNCA toca
# unificard_dev.
...
$EPHEMERAL = "unificard_rfg_containment_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e regional-fund-governance-containment ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-regional-fund-governance-containment.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E REGIONAL-FUND-GOVERNANCE-CONTAINMENT: OK' -ForegroundColor Green
exit 0
