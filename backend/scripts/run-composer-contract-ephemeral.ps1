...
$EPHEMERAL = "unificard_composer_contract_e2e"
...
try {
  ...
  Write-Host 'Provando compositor C1 ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-composer-contract.ts
...
if ($failed) { exit 1 }
Write-Host 'COMPOSER CONTRACT C1: OK' -ForegroundColor Green
exit 0
