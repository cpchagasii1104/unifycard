# run-crm-suppliers-ephemeral.ps1
# Orquestra o E2E F-CRM-PROJECTION-SUPPLIERS-RECONCILIATION em DB EFEMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_crm_suppliers_e2e"
...
try {
  ...
  Write-Host 'Rodando e2e crm-suppliers-reconciliation ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-crm-suppliers-reconciliation.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E CRM-SUPPLIERS-RECONCILIATION: OK' -ForegroundColor Green
exit 0
