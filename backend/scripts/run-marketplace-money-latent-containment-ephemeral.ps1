# run-marketplace-money-latent-containment-ephemeral.ps1
# Orquestra o E2E F-AUTHORITY-Z2-R4-MONEY-LATENT-CONTAINMENT em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_marketplace_money_latent_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e marketplace-money-latent-containment ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-marketplace-money-latent-containment.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E MARKETPLACE-MONEY-LATENT-CONTAINMENT: OK' -ForegroundColor Green
exit 0
