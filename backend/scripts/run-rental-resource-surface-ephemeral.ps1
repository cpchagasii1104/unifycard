# run-rental-resource-surface-ephemeral.ps1
# Orquestra o E2E F-RENTAL-RESOURCE-SURFACE-SLICE-A em DB EFÊMERA. NUNCA toca unificard_dev.
...
$EPHEMERAL = "unificard_rental_resource_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e rental-resource-surface ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-rental-resource-surface.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E RENTAL-RESOURCE-SURFACE: OK' -ForegroundColor Green
exit 0
