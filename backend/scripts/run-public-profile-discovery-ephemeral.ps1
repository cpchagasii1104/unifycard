# run-public-profile-discovery-ephemeral.ps1
...
$EPHEMERAL = "unificard_public_profile_e2e"
...
try {
  ...
  Write-Host '🧪 Rodando e2e public-profile-discovery ...' -ForegroundColor Cyan
  npx tsx src/scripts/validate-pipeline-e2e-public-profile-discovery.ts
...
if ($failed) { exit 1 }
Write-Host 'E2E PUBLIC-PROFILE-DISCOVERY: OK' -ForegroundColor Green
exit 0
