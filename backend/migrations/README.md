...
Este documento preserva a documentação do contrato de migrations que o guard [backend/scripts/check-migration-numbering.js](../scripts/check-migration-numbering.js) aplica.

Para a regra de ambiente, ver [docs/01_normative/LEIS_OPERACIONAIS_UNIFICARD.md](../../docs/01_normative/LEIS_OPERACIONAIS_UNIFICARD.md) — seção REGRA DE AMBIENTE.
