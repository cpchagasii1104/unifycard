...
- **Status:** OPEN (2026-06-01) — D1 tomada (DECISION-0073); implementação (F1/F2/F3) pendente.
...
- **Resolução prevista:** **D1 ✅ (DECISION-0073)** → **F1 ✅ (órfão morto removido)** → **F2 ✅ (vocabulário de credencial reservado: backend zod + UI)** → **F2.1 ✅ (path do client → `/profile/education/events`)** → **F3** selo Educação + **CLOSE** da DT. Credencial verificada real (emissor/prova/autoridade/audit) = frente própria futura, **não** implícita.
