...
- **Status:** PARTIALLY MITIGATED (2026-06-04) — Fase 3.3-A aplicou CHECK em `company_status` (lifecycle DRAFT/PROVISIONAL/ACTIVE/SUSPENDED), **bloqueando os ghosts VERIFIED/APPROVED por schema** (migration `20260604120000`). A segunda-verdade fiscal não pode mais nascer em `company_status` nem por dado nem por runtime. **NÃO fecha:** `is_verified` ainda existe (vestigial, no payload/contrato — Fase 3.3-B). _(antes: OPEN 2026-06-03.)_
