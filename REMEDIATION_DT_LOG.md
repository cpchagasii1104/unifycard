...
- **Resolução prevista:** **F-SAUDE-501 ✅** → **F-TARGETING-DECOUPLE ✅** → **F1a ✅** → **F1b ✅** → **F2 ✅** → **F3 ✅** → **F4 ✅** → **F5 ✅ (cleanup do blob `metadata.lifestyle`)** → **F6** selo `SELO_LIFESTYLE_SSOT.md` + **CLOSE** da DT. Ordem inegociável: política (DECISION-0071) antes de schema/código.
