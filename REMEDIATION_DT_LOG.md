...
- **Resolução prevista:** **D1 ✅** → **F1 ✅** → **F2 ✅** → **D2 ✅ (DECISION-0076)** → **D-GEO ✅ (DECISION-0077 — estratégia B+D+C; lat/lng coarse; F3/F4/F5 bloqueados até F-GEO entregar state_id/city_id)** → **F-GEO-1** (resolver CEP/IBGE — frente compartilhável PF/PJ, fora desta instância) → **F-GEO-2** (enrich addresses) → **F3** core sem blob → **F4** cleanup `profiles.metadata.address` → **F5** selo + CLOSE. Não fechar nesta fatia.
