...
- **Resolução prevista:** **D1 ✅ (DECISION-0073)** → **F1 ✅ (órfão morto removido)** → **F2 ✅ (vocabulário de credencial reservado: backend zod + UI)** → **F3** selo Educação (+ avaliar resíduo do path `/education/events` e CLOSE da DT). Credencial verificada real (emissor/prova/autoridade/audit) = frente própria futura, **não** implícita.
