...
- **Resolução prevista:** **F-SAUDE-501 ✅** → **F-TARGETING-DECOUPLE ✅** → **F1a ✅** → **F1b ✅** → **F2 ✅** → **F3 ✅** → **F4 ✅ (core lê Lifestyle do SSOT; sexualOrientation fora do core)** → **F5** cleanup do blob: `profile-physical.service` para de gravar/ler `metadata.lifestyle` (+ micro-decisão backfill; lifestyle sensível, NÃO confundir com sharedHealthData/preferences) → **F6** selo + CLOSE. Ordem inegociável: política (DECISION-0071) antes de schema/código.
