...
- **Resolução prevista:** **D1 ✅** → **F1 ✅** → **F2 ✅** → **D2 ✅ (DECISION-0076 — enriquecimento transitório; F3/F4 bloqueados por pré-condições)** → **F-GEO** (resolver CEP/catálogo/geocoding canônico — frente compartilhável PF/PJ, fora desta instância) → **F3** readers/core sem blob → **F4** cleanup `profiles.metadata.address` → **F5** selo + CLOSE. Não fechar nesta fatia.
